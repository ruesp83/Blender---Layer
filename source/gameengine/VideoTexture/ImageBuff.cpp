...
void ImageBuff::plot(unsigned char *img, short width, short height, short x, short y, short mode)
{
	...
	IMB_rectblend(m_imbuf, m_imbuf, tmpbuf, NULL, NULL, 0, x, y, x, y, 0, 0, width, height, (IMB_BlendMode)mode, 2);
...
void ImageBuff::plot(ImageBuff *img, short x, short y, short mode)
{
	...
	m_imbuf->rect = m_image;
	IMB_rectblend(m_imbuf, m_imbuf, img->m_imbuf, NULL, NULL, 0, x, y, x, y, 0, 0, img->m_imbuf->x, img->m_imbuf->y, (IMB_BlendMode)mode, 2);
	// remove so that MB_freeImBuf will free our buffer
	m_imbuf->rect = NULL;
